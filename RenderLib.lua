local renderer = {}
renderer.Zero = Vector.Zero or Vector(0, 0)

local function GetScreenSize() -- By Kilburn himself.
  local room = Game():GetRoom()
  local pos = Isaac.WorldToScreen(renderer.Zero) - room:GetRenderScrollOffset() - Game().ScreenShakeOffset
...
function renderer.SmartRender(self, sprite, ScreenSpace, TopLeftClamp, BottomRightClamp)
  TopLeftClamp = TopLeftClamp or renderer.Zero
  BottomRightClamp = BottomRightClamp or renderer.Zero
